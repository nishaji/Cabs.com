 ...
 */
public class MapsActivity2 extends Activity implements MapWrapperLayout.OnDragListener {
    ...
    String completeAddress,pickup,list1;
    ...
    private void initializeUI() {
        ...
        mLocationTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                list1= intent2.getStringExtra("list1");
                Intent intent=getIntent();
                pickup= intent.getStringExtra("pickupvalue");
                Intent intent1 = new Intent(getApplicationContext(), Bookings.class);
                intent1.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent1.putExtra("drop",completeAddress);
                intent1.putExtra("pickup",pickup);
                intent1.putExtra("ListData",list1);
    ...
    private void initilizeMap() {
        if (googleMap == null) {
            ...
            CameraUpdate center= CameraUpdateFactory.newLatLng(new LatLng(28.6139, 77.2090));
            CameraUpdate zoom=CameraUpdateFactory.zoomTo(15);
            googleMap = mCustomMapFragment.getMap();
            googleMap.moveCamera(center);
            googleMap.animateCamera(zoom);
            mCustomMapFragment.setOnDragListener(MapsActivity2.this);
