...
public class AddcarActivity extends Activity {
    ...
    String make, model, range, registration, color, id, email;
    ...
    private void savecardata() {
        if(et1.getText().toString().equals("")||et2.getText().toString().equals("")||t1.getText().toString().equals("")||
                ...
                if (!make.isEmpty()) if (note == null) {
                    ...
                    post.saveEventually(new SaveCallback() {
                        public void done(com.parse.ParseException e) {
                            if (e == null) {
                                Toast.makeText(AddcarActivity.this, "You SucessFully save your data on parse !", Toast.LENGTH_SHORT).show();
                            } else {
